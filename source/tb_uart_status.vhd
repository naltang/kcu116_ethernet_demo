...
architecture sim of tb_uart_status is
    ...
    constant EXPECTED_LINE : string :=
        ...
        " STS1=0x000D RECR=0x000E CFG4=0x000F" &
        " STRAP_STS2=0x0010 ANA_LD_DATA_CTRL=0x0011" & CR & LF;
...
begin
    ...
    begin
        ...
        status.phy.cfg4               <= x"000F";
        status.phy.strap_sts2         <= x"0010";
        status.phy.ana_ld_data_ctrl   <= x"0011";
